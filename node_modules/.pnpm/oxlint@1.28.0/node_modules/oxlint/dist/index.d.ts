 ...
 * @returns Array of `Token`s.
 */
declare function getTokens(node: Node, countOptions?: CountOptions | number | FilterFn | null | undefined, afterCount?: number | null | undefined): Token[];
/**
 ...
 */
declare function getFirstToken(node: Node, skipOptions?: SkipOptions | number | FilterFn | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s.
 */
declare function getFirstTokens(node: Node, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns `Token`, or `null` if all were skipped.
 */
declare function getLastToken(node: Node, skipOptions?: SkipOptions | number | FilterFn | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s.
 */
declare function getLastTokens(node: Node, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns `Token`, or `null` if all were skipped.
 */
declare function getTokenBefore(nodeOrToken: NodeOrToken | Comment, skipOptions?: SkipOptions | number | FilterFn | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s.
 */
declare function getTokensBefore(nodeOrToken: NodeOrToken | Comment, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns `Token`, or `null` if all were skipped.
 */
declare function getTokenAfter(nodeOrToken: NodeOrToken | Comment, skipOptions?: SkipOptions | number | FilterFn | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s.
 */
declare function getTokensAfter(nodeOrToken: NodeOrToken | Comment, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns Array of `Token`s between `nodeOrToken1` and `nodeOrToken2`.
 */
declare function getTokensBetween(nodeOrToken1: NodeOrToken | Comment, nodeOrToken2: NodeOrToken | Comment, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns `Token`, or `null` if all were skipped.
 */
declare function getFirstTokenBetween(nodeOrToken1: NodeOrToken | Comment, nodeOrToken2: NodeOrToken | Comment, skipOptions?: SkipOptions | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s between `nodeOrToken1` and `nodeOrToken2`.
 */
declare function getFirstTokensBetween(nodeOrToken1: NodeOrToken | Comment, nodeOrToken2: NodeOrToken | Comment, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 * @returns `Token`, or `null` if all were skipped.
 */
declare function getLastTokenBetween(nodeOrToken1: NodeOrToken | Comment, nodeOrToken2: NodeOrToken | Comment, skipOptions?: SkipOptions | null | undefined): Token | null;
/**
 ...
 * @returns Array of `Token`s between `nodeOrToken1` and `nodeOrToken2`.
 */
declare function getLastTokensBetween(nodeOrToken1: NodeOrToken | Comment, nodeOrToken2: NodeOrToken | Comment, countOptions?: CountOptions | number | FilterFn | null | undefined): Token[];
/**
 ...
 */
declare function getTokenByRangeStart(index: number, rangeOptions?: RangeOptions | null | undefined): Token | null;
/**
 ...
 */
declare function isSpaceBetween(nodeOrToken1: NodeOrToken, nodeOrToken2: NodeOrToken): boolean;
//#endregion
 ...
 */
type LanguageOptions = typeof LANGUAGE_OPTIONS;
...
//#endregion
export { type AfterHook, type BeforeHook, type Comment, type Context, type CountOptions, type CreateOnceRule, type CreateRule, type Definition, type DefinitionType, type Diagnostic, type DiagnosticBase, type DiagnosticWithLoc, type DiagnosticWithNode, type types_d_exports as ESTree, type FilterFn, type Fix, type FixFn, type Fixer, type LanguageOptions, type LineColumn, type Location, type Node, type NodeOrToken, type Plugin, type Range, type RangeOptions, type Ranged, type Reference, type Rule, type RuleMeta, type Scope, type ScopeManager, type ScopeType, type SkipOptions, type SourceCode, type Span, type Token, type Variable, type VisitorObject as Visitor, type VisitorWithHooks, definePlugin, defineRule };